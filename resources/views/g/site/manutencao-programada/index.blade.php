    ...
    <form>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-2">
                <div class="form-group">
                    <input type="text" class="form-control data" readonly id="data" :disabled="preloadAjax"
                           onblur="valida_data(this)" v-mascara:data>
                </div>
                <div class="form-group">
                    <input type="time" class="form-control" id="hora" :disabled="preloadAjax"
