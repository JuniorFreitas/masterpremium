<template>
    <div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-secondary" @click.stop="onClick"><i class="fa fa-search"></i>
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-2 col-md-2 col-lg-2 col-xl-2" v-if="!select">
                <div class="form-group">
                    <label>Número</label>
            ...
            <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4" v-if="!select">
                <div class="form-group">
